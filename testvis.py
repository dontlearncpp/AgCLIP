...
def main(args):
    ...
    dst_dir = '/home/test/countx/keshihua/img'
    srcheat_dir = '/media/test/run/count/countx/CounTX-main-arg-4-conv-loss-auxloss/vis/'
    heat_dir = '/home/test/countx/keshihua/heat'
